- Crate overview
	...
	- `num-dual`
		- TODO clone repo and impl `geo_traits::Number` for dual number types
	- `curves`
...
- Combine RK methods with arrays of dual numbers to perform multivariate numerical integration
...
- Tech Stack
	- GPU integration: https://vulkano.rs
	- UI: https://crates.io/crates/egui_winit_vulkano
